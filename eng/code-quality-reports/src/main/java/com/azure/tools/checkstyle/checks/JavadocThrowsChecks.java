...
public class JavadocThrowsChecks extends AbstractCheck {
    private static final String MISSING_DESCRIPTION_MESSAGE = "@throws tag requires a description explaining when the"
        + "error is thrown.";
    ...
    private void setIdentifierAndCheckStatus(DetailAST scopeDefToken) {
        ...
        currentScopeNeedsChecking = visibilityIsPublicOrProtectedAndNotAbstractOrOverride(scopeDefToken
