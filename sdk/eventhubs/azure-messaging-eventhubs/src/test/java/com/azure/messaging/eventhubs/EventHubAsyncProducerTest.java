...
public class EventHubAsyncProducerTest {
    ...
    public void sendTooManyMessages() {
        ...
        final SendOptions options = new SendOptions();
        final EventHubProducerOptions producerOptions =
            new EventHubProducerOptions().retry(new RetryOptions().tryTimeout(Duration.ofSeconds(30)));
    ...
    static final String TEST_CONTENTS = "SSLorem ipsum dolor sit amet, consectetur adipiscing elit. Donec vehicula "
        + "posuere lobortis. Aliquam finibus volutpat dolor, faucibus pellentesque ipsum bibendum vitae. Class aptent"
        + " taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Ut sit amet urna "
        + "hendrerit, dapibus justo a, sodales justo. Mauris finibus augue id pulvinar congue. Nam maximus luctus "
        + "ipsum, at commodo ligula euismod ac. Phasellus vitae lacus sit amet diam porta placerat. \n"
