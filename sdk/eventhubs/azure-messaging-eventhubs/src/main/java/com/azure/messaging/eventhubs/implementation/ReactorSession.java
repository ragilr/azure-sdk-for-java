            ...
            .then(tokenManager.authorize().then(Mono.create(sink -> {
                ...
                try {
                    provider.getReactorDispatcher().invoke(() -> {
                        sender.open();
                        final ReactorSender reactorSender = new ReactorSender(entityPath, sender, sendLinkHandler,
                            provider, tokenManager, timeout, retry, EventHubAsyncProducer.MAX_MESSAGE_LENGTH_BYTES);
            ...
            .then(tokenManager.authorize().then(Mono.create(sink -> {
                ...
                try {
                    provider.getReactorDispatcher().invoke(() -> {
                        ...
                        final ReactorReceiver reactorReceiver = new ReactorReceiver(entityPath, receiver,
