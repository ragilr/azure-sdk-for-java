...
public interface HttpResponseDecodeData {
     ...
     *
     * 'Matching' headers are the HTTP response headers those with: 1. header names same as name of a properties in the
     * 'header entity'. 2. header names start with value of {@link HeaderCollection} annotation applied to the
     * properties in the 'header entity'.
     *
     ...
     *
     * When this method return non-null {@code java.lang.reflect.Type} then the raw HTTP response content will need to
     * parsed to this {@code java.lang.reflect.Type} then converted to actual {@code returnType}.
     *
