...
public final class SecretClient {
     ...
     * asynchronously and prints out the returned secret details when a response is received.</p> {@codesnippet
     * com.azure.security.keyvault.secretclient.getSecretWithResponse#string-string-Context}
     *
     * @param name The name of the secret, cannot be null
     * @param version The version of the secret to retrieve. If this is an empty String or null, this call is equivalent
     * to calling {@link #getSecret(String)}, with the latest version being retrieved.
     ...
     * secret
     * returned in the response.</p> //Assuming secret is deleted on a soft-delete enabled key vault. {@codesnippet
     * com.azure.security.keyvault.secretclient.getDeletedSecret#string}
     *
     ...
     * secret
     * returned in the response.</p> //Assuming secret is deleted on a soft-delete enabled key vault. {@codesnippet
     * com.azure.security.keyvault.secretclient.getDeletedSecretWithResponse#string-Context}
     *
     * @param name The name of the deleted secret.
     * @param context Additional context that is passed through the Http pipeline during the service call.
     *
     ...
     * server response.</p>
     * //Assuming secret is deleted on a soft-delete enabled key vault. {@codesnippet
     * com.azure.security.keyvault.secretclient.purgeDeletedSecret#string}
     *
     * @param name The name of the secret.
     *
     ...
     * server response.</p>
     * //Assuming secret is deleted on a soft-delete enabled key vault. {@codesnippet
     * com.azure.security.keyvault.secretclient.purgeDeletedSecret#string-Context}
     *
     * @param name The name of the secret.
     * @param context Additional context that is passed through the Http pipeline during the service call.
     *
     ...
     * recovered secret
     * returned in the response.</p> //Assuming secret is deleted on a soft-delete enabled key vault. {@codesnippet
     * com.azure.security.keyvault.secretclient.recoverDeletedSecret#string}
     *
     ...
     * recovered secret
     * returned in the response.</p> //Assuming secret is deleted on a soft-delete enabled key vault. {@codesnippet
     * com.azure.security.keyvault.secretclient.recoverDeletedSecretWithResponse#string-Context}
     *
     * @param name The name of the deleted secret to be recovered.
     * @param context Additional context that is passed through the Http pipeline during the service call.
     *
