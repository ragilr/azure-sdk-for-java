...
public final class SecretAsyncClient {
     ...
     * prints out the newly created secret details when a response is received.</p> {@codesnippet
     * com.azure.keyvault.secrets.secretclient.setSecret#secret}
     *
     ...
     * call asynchronously and
     * prints out the newly created secret details when a response is received.</p> {@codesnippet
     * com.azure.keyvault.secrets.secretclient.setSecretWithResponse#secret}
     *
     * @param secret The Secret object containing information about the secret and its properties. The properties
     * secret.name and secret.value must be non null.
     *
     ...
     * com.azure.keyvault.secrets.secretclient.getSecret#string-string}
     *
     ...
     * <p>Gets a specific version of the secret in the key vault. Subscribes to the call
     * asynchronously and prints out the returned secret details when a response is received.</p> {@codesnippet
     * com.azure.keyvault.secrets.secretclient.getSecretWithResponse#string-string}
     *
     * @param name The name of the secret, cannot be null
     * @param version The version of the secret to retrieve. If this is an empty String or null, this call is equivalent
     * to calling {@link #getSecret(String)}, with the latest version being retrieved.
     ...
     * <p><strong>Code Samples</strong></p>
     * <p>Backs up the secret from the key vault. Subscribes to the call asynchronously and prints out
     * the length of the secret's backup byte array returned in the response.</p> {@codesnippet
     * com.azure.keyvault.secrets.secretclient.backupSecretWithResponse#string}
     *
     * @param name The name of the secret.
     *
