...
public final class CryptographyClient {
     ...
     * RSA_OAEP} and {@link EncryptionAlgorithm#RSA_OAEP_256 RSA_OAEP_256}. Possible values for symmetric keys include:
     * {@link EncryptionAlgorithm#A128CBC A128CBC}, {@link EncryptionAlgorithm#A128CBC_HS256 A128CBC-HS256}, {@link
     * EncryptionAlgorithm#A192CBC A192CBC}, {@link EncryptionAlgorithm#A192CBC_HS384 A192CBC-HS384}, {@link
     ...
     */
    public EncryptResult encrypt(EncryptionAlgorithm algorithm, byte[] plaintext, byte[] iv,
                                 byte[] authenticationData, Context context) {
     ...
     */
    public DecryptResult decrypt(EncryptionAlgorithm algorithm, byte[] cipherText, byte[] iv,
     ...
     * {@link KeyWrapAlgorithm#RSA1_5 RSA1_5}, {@link KeyWrapAlgorithm#RSA_OAEP RSA_OAEP} and {@link
     * KeyWrapAlgorithm#RSA_OAEP_256 RSA_OAEP_256}. Possible values for symmetric keys include: {@link
     * KeyWrapAlgorithm#A128KW A128KW}, {@link KeyWrapAlgorithm#A192KW A192KW} and {@link KeyWrapAlgorithm#A256KW
     * A256KW}</p>
     *
     * <p><strong>Code Samples</strong></p>
