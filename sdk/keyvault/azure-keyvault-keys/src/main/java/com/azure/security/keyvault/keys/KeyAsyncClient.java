...
public final class KeyAsyncClient {
    ...
    Mono<Response<Key>> createKeyWithResponse(String name, KeyType keyType, Context context) {
        ...
        return service
            .createKey(endpoint, name, API_VERSION, ACCEPT_LANGUAGE, parameters, CONTENT_TYPE_HEADER_VALUE, context)
    ...
    Mono<Response<Key>> createKeyWithResponse(KeyCreateOptions keyCreateOptions, Context context) {
        ...
        return service
            .createKey(endpoint, keyCreateOptions.name(), API_VERSION, ACCEPT_LANGUAGE, parameters,
    ...
    Mono<Response<Key>> createRsaKeyWithResponse(RsaKeyCreateOptions rsaKeyCreateOptions, Context context) {
        ...
        return service
            .createKey(endpoint, rsaKeyCreateOptions.name(), API_VERSION, ACCEPT_LANGUAGE, parameters,
                CONTENT_TYPE_HEADER_VALUE, context)
    ...
    Mono<Response<Key>> createEcKeyWithResponse(EcKeyCreateOptions ecKeyCreateOptions, Context context) {
        ...
        return service
            .createKey(endpoint, ecKeyCreateOptions.name(), API_VERSION, ACCEPT_LANGUAGE, parameters,
                CONTENT_TYPE_HEADER_VALUE, context)
    ...
    Mono<Response<Key>> importKeyWithResponse(String name, JsonWebKey keyMaterial, Context context) {
        ...
        return service
            .importKey(endpoint, name, API_VERSION, ACCEPT_LANGUAGE, parameters, CONTENT_TYPE_HEADER_VALUE, context)
    ...
    Mono<Response<Key>> importKeyWithResponse(KeyImportOptions keyImportOptions, Context context) {
        ...
        return service
            .importKey(endpoint, keyImportOptions.name(), API_VERSION, ACCEPT_LANGUAGE, parameters,
                CONTENT_TYPE_HEADER_VALUE, context)
     ...
     * calling {@link KeyAsyncClient#getKey(String)}, with the latest version being retrieved.
     *
     ...
     * return
     * the {@link Flux} containing {@link KeyBase base key} as output excluding the key material of the key. This
    ...
    Mono<Response<Key>> updateKeyWithResponse(KeyBase key, Context context) {
        ...
        return service
            .updateKey(endpoint, key.name(), key.version(), API_VERSION, ACCEPT_LANGUAGE, parameters,
                CONTENT_TYPE_HEADER_VALUE, context)
     ...
     * prints out the
     * deleted key details when a response has been received.</p> //Assuming key is deleted on a soft-delete enabled
     * vault.
     *
     ...
     * vault. {@codesnippet com.azure.security.keyvault.keys.async.keyclient.getDeletedKeyWithResponse#string}
     *
     * @param name The name of the deleted key.
     *
     * @return A {@link Mono} containing a {@link Response} whose {@link Response#value() value} contains the {@link
     ...
     * prints out the
     * status code from the server response when a response has been received.</p> //Assuming key is deleted on a
     * soft-delete enabled vault. {@codesnippet com.azure.security.keyvault.keys.async.keyclient.purgeDeletedKey#string}
     *
     * @param name The name of the deleted key.
     *
     ...
     * prints out the
     * recovered key details when a response has been received.</p> //Assuming key is deleted on a soft-delete enabled
     * vault. {@codesnippet com.azure.security.keyvault.keys.async.keyclient.recoverDeletedKey#string}
     *
     ...
     * prints out the
     * recovered key details when a response has been received.</p> //Assuming key is deleted on a soft-delete enabled
     * vault. {@codesnippet com.azure.security.keyvault.keys.async.keyclient.recoverDeletedKeyWithResponse#string}
     *
     * @param name The name of the deleted key to be recovered.
     *
     * @return A {@link Mono} containing a {@link Response} whose {@link Response#value() value} contains the {@link Key
    ...
    Mono<Response<Key>> recoverDeletedKeyWithResponse(String name, Context context) {
        return service
            .recoverDeletedKey(endpoint, name, API_VERSION, ACCEPT_LANGUAGE, CONTENT_TYPE_HEADER_VALUE, context)
     ...
     * restored key
     * details when a response has been received.</p> //Pass the Key Backup Byte array to the restore operation.
     *
    ...
    Mono<Response<Key>> restoreKeyWithResponse(byte[] backup, Context context) {
        ...
        return service
            .restoreKey(endpoint, API_VERSION, parameters, ACCEPT_LANGUAGE, CONTENT_TYPE_HEADER_VALUE, context)
    ...
    private Mono<PagedResponse<KeyBase>> listKeysFirstPage(Context context) {
        return service
            .getKeys(endpoint, DEFAULT_MAX_PAGE_RESULTS, API_VERSION, ACCEPT_LANGUAGE,
                CONTENT_TYPE_HEADER_VALUE, context)
    ...
    private Mono<PagedResponse<DeletedKey>> listDeletedKeysFirstPage(Context context) {
        return service
            .getDeletedKeys(endpoint, DEFAULT_MAX_PAGE_RESULTS, API_VERSION, ACCEPT_LANGUAGE,
                CONTENT_TYPE_HEADER_VALUE, context)
     ...
     * Flux}
     * containing {@link KeyBase base key} to {@link Flux} containing {@link Key key} using {@link
     * KeyAsyncClient#getKey(KeyBase baseKey)} within {@link Flux#flatMap(Function)}.</p>
     *
