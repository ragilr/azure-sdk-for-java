...
public final class KeyClient {
     ...
     * operation can then be used to get the full key with its key material from {@code keyBase}. </p> {@codesnippet
     * com.azure.keyvault.keys.keyclient.getKey#KeyBase}
     *
     ...
     * the {@link List} containing {@link KeyBase base key} as output excluding the key material of the key. This
     * operation can then be used to get the full key with its key material from {@code keyBase}. </p> {@codesnippet
     * com.azure.keyvault.keys.keyclient.getKeyWithResponse#KeyBase-Context}
     *
     * @param keyBase The {@link KeyBase base key} holding attributes of the key being requested.
     * @param context Additional context that is passed through the Http pipeline during the service call.
     *
     ...
     * returned in the response.</p> //Assuming key is deleted on a soft-delete enabled key vault. {@codesnippet
     * com.azure.keyvault.keys.keyclient.getDeletedKey#string}
     *
     ...
     * <p>Gets the deleted key from the key vault enabled for soft-delete. Prints out the details of the deleted key
     * returned in the response.</p> //Assuming key is deleted on a soft-delete enabled key vault. {@codesnippet
     * com.azure.keyvault.keys.keyclient.getDeletedKeyWithResponse#string-Context}
     *
     * @param name The name of the deleted key.
     * @param context Additional context that is passed through the Http pipeline during the service call.
     *
