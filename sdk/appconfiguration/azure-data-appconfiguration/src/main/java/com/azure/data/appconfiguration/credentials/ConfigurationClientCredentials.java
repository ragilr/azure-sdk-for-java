...
public class ConfigurationClientCredentials {
     ...
     *
     * @param connectionString Connection string in the format "endpoint={endpoint_value};id={id_value};secret={
     * secret_value}"
     *
     ...
     */
    public ConfigurationClientCredentials(String connectionString) throws InvalidKeyException,
    ...
    public Mono<Map<String, String>> getAuthorizationHeadersAsync(URL url, String httpMethod,
        ...
        return contents.collect(
            ...
            .flatMap(messageDigest -> Mono.just(headerProvider.getAuthenticationHeaders(url, httpMethod,
                messageDigest)));
    }
    ...
    private static class AuthorizationHeaderProvider {
        ...
        AuthorizationHeaderProvider(CredentialInformation credentials) throws NoSuchAlgorithmException,
            InvalidKeyException {
        ...
        private void addSignatureHeader(final URL url, final String httpMethod, final Map<String, String> httpHeaders) {
            ...
            httpHeaders.put(AUTHORIZATION_HEADER, String.format("HMAC-SHA256 Credential=%s, SignedHeaders=%s, "
                    + "Signature=%s",
                credentials.id(),
                signedHeadersValue,
                signature));
